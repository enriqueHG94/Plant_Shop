...
# Read data from the budget table of the silver zone
fct_budget = pd.read_sql_table('trf_budget', silver_engine, schema='csv')
...
fct_budget.to_sql('fct_budget', gold_engine, if_exists='replace', index=False, schema='csv')

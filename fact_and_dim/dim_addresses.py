...
# Read data from the products table of the silver zone
dim_addresses = pd.read_sql_table('trf_addresses', silver_engine, schema='csv')
...
dim_addresses.to_sql('dim_addresses', gold_engine, if_exists='replace', index=False, schema='csv')

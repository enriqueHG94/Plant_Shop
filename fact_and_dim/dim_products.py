...
dim_products = pd.read_sql_table('trf_products', silver_engine, schema='csv')
...
dim_products.to_sql('dim_products', gold_engine, if_exists='replace', index=False, schema='csv')
